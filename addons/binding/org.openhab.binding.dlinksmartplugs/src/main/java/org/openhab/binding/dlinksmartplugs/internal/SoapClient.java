...
/**
 * The {@link SoapClient} is responsible for managing soap calls to the plug.
 * It is special in that it builds the soap xml manually because a true API does not exist.
 *
...
public class SoapClient {
    ...
    /**
     * Method to login and get authentication values.
     *
     * @param user
     * @param password
     * @param url
    ...
    /**
     * Method to get plug consumption.
     */
    ...
    /**
     * Method to get plug total consumption.
     */
    ...
    /**
     * Method to get plug temperature.
     */
    ...
    /**
     * Method to get plug api client settings.
     * not currently used
     */
    ...
    /**
     * Method to set plug power warning.
     * not currently used
     */
    ...
    /**
     * Method to get plug power warning.
     */
    ...
    /**
     * Method to get plug temperature settings.
     * not currently used
     */
    ...
    /**
     * Method to set plug temperature settings.
     * not currently used
     */
    ...
    /**
     * Method to get plug site survey.
     * not currently used
     */
    ...
    /**
     * Method to trigger wireless site survey.
     * not currently used
     */
    ...
    /**
     * Method to get plug latest detection.
     * not currently used
     */
    ...
    /**
     * Method to check if device is ready.
     * not currently used
     */
    ...
    /**
     * Method to get plug module schedule.
     * not currently used
     */
    ...
    /**
     * Method to get schedule settings.
     * not currently used
     */
    ...
    /**
     * Method to get internet settings.
     * not currently used
     */
    ...
    /**
     * Method to set AP client settings.
     * not currently used
     */
    ...
    private String APClientParameters() {
        ...
        return "<Enabled>true</Enabled>" + "<RadioID>RADIO_2.4GHz</RadioID>" + "<SSID>My_Network</SSID>"
                ...
                + org.openhab.binding.dlinksmartplugs.internal.AES.encrypt("password", HNAP_AUTH.PrivateKey) + "</Key>";
    }
